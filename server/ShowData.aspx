    ...
    <form id="form1" runat="server">
        <div style="float: left;margin-left:10px">
            ...
            <div style="float:left;margin-left:1px">
                <asp:GridView ID="user" runat="server" onrowupdating="user_RowUpdating" BackColor="White" BorderColor="White" BorderStyle="Ridge" BorderWidth="1px" CellPadding="1" EnableModelValidation="True" CellSpacing="1" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" AutoGenerateSelectButton="True" OnDataBinding="Page_Load" OnRowCancelingEdit="user_RowCancelingEdit" OnRowDeleted="user_RowDeleted" OnRowDeleting="user_RowDeleting" OnRowEditing="user_RowEditing" OnRowUpdated="user_RowUpdated">
